...
export const updateProfile = createAsyncThunk(
  ...
  async (userData, { rejectWithValue }) => {
    try {
      ...
      return data.success; // Adjust this based on your API response
    } catch (error) {
...
//       state.loading = false;
//       state.isAuthenticated = true; // Assuming registration also logs in the user
//       state.user = action.payload;
//       state.error = null;
//     },
